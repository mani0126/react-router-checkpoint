            ...
            <Form onSubmit={this.userSignup}>
              ...
              <FormGroup>
                ...
                <Input
                  ...
                  onChange={e =>
                    this.setState({ email: e.target.value, missingValues: false})
                  }
                />
              </FormGroup>
               <FormGroup>
              ...
              <FormGroup>
                ...
                <Input
                  ...
                  onChange={e =>
                    this.setState({ phone: e.target.value, missingValues: false })
                  }
                />
              </FormGroup>
              <FormGroup>
              ...
              <FormGroup>
                ...
                {this.state.missingValues ? (
                    <Alert color="primary">
                        Name and email is required. Please try again.
                    </Alert>
                ) : null}
